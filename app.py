...
if page == "Defense Rotation Planner":
    ...
    if len(team_players) < 8:
        ...
        if st.button("🗑️ Clear All Innings"):
            ...
            st.success("All innings cleared!")
            st.rerun()
...
st.sidebar.caption("v1.0 • Fixed Clearing • P+C Infield Rule • Auto-Save • Orioles ⚾")
